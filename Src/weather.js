...
document.addEventListener('DOMContentLoaded', function(){
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(position => {
          ...
          fetch('https://api.openweathermap.org/data/2.5/onecall?lat=' + lat + '&lon=' + long + '&units=metric&exclude=minutely,hourly,alerts&appid=851c447363aefd30ca3673f25c0318a0')
          ...
          .then(data => {
              ...
              description.innerHTML = 'It is currently ' + tempValue + '°C' + ' with ' + condition;
            })
        }, error => {
